      ...
      <div class="os-tabs-w">
         <div class="os-tabs-controls">
           <ul class="nav nav-tabs upper">
            <li class="nav-item">
              <a class="nav-link active" href="admission_report.php">Admission Report</a>
            </li>
            <li class="nav-item">
		...
		<div class="row xs-mt-20">
								...
								<div class="col-md-3">
									<div class="form-group btns">
										...
										<br/>
										<button class="btn btn-primary" onClick="getstudentreport()">Generate</button>
									</div>
								</div>
								
								<div id="sreport" class="col-md-12">
...
<script type="text/javascript" src="../vendor/tableExport.jquery.plugin-master/jspdf/libs/base64.js"></script>
  ...
  {
var html="<html>";
html+="<head></head><body><h2>Sofica Public School Admission Report</h2>";
  ...
  xhttp.onreadystatechange = function() {
    if (this.readyState == 4 && this.status == 200) {
      document.getElementById("sreport").innerHTML =this.responseText;
    }
  };
  xhttp.open("GET", "getsreport.php?course_id="+course_id+"&year="+year+"&academic_year="+academic_year, true);
  xhttp.send();
}
  function selcourse() {
  var xhttp = new XMLHttpRequest();
