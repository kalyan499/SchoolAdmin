...
<div class="container-fluid no-padding body-content">
	  ...
	  <div class="table-responsive">
                                           <table class="table table-striped table-bordered table-hover no-margin-bottom no-border-top" id="example">
												...
												<?php
												$sn=1;
$sql="select * from students s,courses c where s.course_id=c.course_id and academic_year='".$_SESSION["academic_year"]."' order by student_id desc";
$res=$db->query($sql);
												...
												?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="student_profile.php?sid=<?php echo $row["student_id"]; ?>"><?php echo $row["first_name"]." ".$row["last_name"]; ?></a>
                                                        </td>
                                                        ...
                                                        <td>
                                                            <div class="hidden-sm hidden-xs btn-group">
                                                                <a href="student_profile.php?sid=<?php echo $row["student_id"]; ?>" class="btn btn-sm btn-success">
                                                                    <i class="ace-icon fa fa-eye bigger-120"></i>
                                                                </a>
                                                                <a class="btn btn-sm btn-info" href="admission_edit.php?sid=<?php echo $row["student_id"]; ?>">
                                                                    <i class="ace-icon fa fa-pencil bigger-120"></i>
                                                                </a>
                                                              <a href="#"  class="btn btn-sm btn-danger" onClick="calert('Are you sure you want to delete this?','students_delete.php?student_id=<?php echo $row["student_id"]; ?>')"><i class="ace-icon fa fa-trash-o bigger-120"></i></a>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                     <?php
