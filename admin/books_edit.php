...
{
?>
<option value="<?php echo $rowr["author_id"]; ?>" <?php if($rowr['author_id']==$row['author_id']){ echo "selected";} ?>><?php echo $rowr["author_name"]; ?></option>
<?php
}
?>
</select>
...
<label class="col-sm-3 form-control-label no-padding-right" for="availability">Availability:</label>
  ...
  <option value="">Select Availability Staus</option>
    ...
    <option <?php if($row['availability']=="Lost"){ echo "selected";} ?>>Lost</option>
    <option <?php if($row['availability']=="Damaged"){ echo "selected";} ?>>Damaged</option>
    <option <?php if($row['availability']=="Outdated"){ echo "selected";} ?>>Outdated</option>
