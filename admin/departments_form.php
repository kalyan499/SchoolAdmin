        ...
        <div class="content-inner">
          ...
          <header class="page-header">
            ...
            <div class="container-fluid">
              ...
              <h2 class="no-margin-bottom">Add New Departments</h2>
...
<label class="col-sm-3 form-control-label no-padding-right" for="department_name">Department Name:</label>
    ...
    <input type="text" id="department_name" name="department_name" class="col-xs-10 col-sm-5 form-control" placeholder="Department Name:" required>
