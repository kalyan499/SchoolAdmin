      ...
      <div class="os-tabs-w">
         <div class="os-tabs-controls">
           <ul class="nav nav-tabs upper">
			...
			<li class="nav-item">
              <a class="nav-link active" href="departments_view.php">Departments</a>
            </li> 
			<li class="nav-item">
...
$res=$db->query($sql);
 ...
 ?>
 <form method="post" action="departments_insert.php" id="formID"  class="form-horizontal">
...
<td class="hidden-sm hidden-xs btn-group"><a href="departments_view.php?did=<?php echo $row["department_id"]; ?>" class="btn btn-sm btn-info"><i class="ace-icon fa fa-pencil bigger-120"></i></a><a href="departments_delete.php?department_id=<?php echo $row["department_id"]; ?>"  class="btn btn-sm btn-danger" onClick="return confirm('Are you sure you want to delete this?')"><i class="ace-icon fa fa-trash-o bigger-120"></i></a></td>
</tr>
<?php
}
?>
