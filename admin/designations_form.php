        ...
        <div class="content-inner">
          ...
          <header class="page-header">
            ...
            <div class="container-fluid">
              ...
              <h2 class="no-margin-bottom">Add New Designations</h2>
...
<label class="col-sm-3 form-control-label no-padding-right" for="designation">Designation:</label>
    ...
    <input type="text" id="designation" name="designation" class="col-xs-10 col-sm-5 form-control" placeholder="Designation:" required>
