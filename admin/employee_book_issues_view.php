      ...
      <div class="os-tabs-w">
         <div class="os-tabs-controls">
           <ul class="nav nav-tabs upper">
            ...
            <li class="nav-item">
              <a class="nav-link" href="student_book_issues_view.php">Books Issued To Student</a>
            </li> 
			<li class="nav-item">
              <a class="nav-link active" href="employee_book_issues_view.php">Books Issued To Staff</a>
            </li> 
           </ul>
         </div>
        </div>
