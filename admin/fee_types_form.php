        ...
        <div class="content-inner">
          ...
          <header class="page-header">
            ...
            <div class="container-fluid">
              ...
              <h2 class="no-margin-bottom">Add New Fee Types</h2>
...
<label class="col-sm-3 form-control-label no-padding-right" for="fee_type">Fee Type:</label>
    ...
    <input type="text" id="fee_type" name="fee_type" class="col-xs-10 col-sm-5 form-control" placeholder="Fee Type:" required>
