...
?>
 <div class="row export-section">
                                                    ...
                                                    <div class="col-md-12 text-right">
                                                        <a href="#" class="btn btn-sm btn-default text-success" onClick ="getstudentfreportexcel()"><i class="fa fa-file-excel-o"></i></a>
                                                        <a href="#" class="btn btn-sm btn-default text-danger" onClick ="$('#sfreport').tableExport({type:'pdf',escape:'false'});"><i class="fa fa-file-pdf-o"></i></a>
                                                      <button class="btn btn-sm btn-default" onClick="divp('sfreport')"><i class="fa fa-print"></i></button>
                                                    </div>
</div>
<?php
