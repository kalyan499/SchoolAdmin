...
$sql="select * from students s,courses c,religions t2,castes t3,categories t4,countries t5,states t6 where s.course_id=c.course_id and s.religion_id=t2.religion_id and s.caste_id=t3.caste_id and s.category_id=t4.category_id and s.state_id =t6.state_id and s.country_id=t5.country_id and academic_year='$academic_year'".$sql1;
?>
