         ...
         <div class="os-tabs-controls">
           <ul class="nav nav-tabs upper">
            ...
            <li class="nav-item">
			 ...
			 <li class="nav-item">
              <a class="nav-link active" href="hostel_report.php">Hostel Report</a>
            </li> 
			 <li class="nav-item">
                                          ...
                                          <option value="">Select Grade</option>
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="form-group btns">
                                                            ...
                                                            <br/>
                                                            <button class="btn btn-primary" onClick="gethstudentreport()">Generate</button>
                                                         
                                                        </div>
                                                    </div>
                                        
										<div id="hreport" class="col-md-12">
...
<script type="text/javascript" src="../vendor/tableExport.jquery.plugin-master/jspdf/libs/base64.js"></script>
  ...
  {
var html="<html>";
html+="<head></head><body><h2>Sofica Public School Hostel Report</h2>";
  ...
  xhttp.onreadystatechange = function() {
    if (this.readyState == 4 && this.status == 200) {
      document.getElementById("hreport").innerHTML =this.responseText;
    }
  };
  xhttp.open("GET", "getshreport.php?course_id="+course_id+"&year="+year+"&academic_year="+academic_year, true);
  xhttp.send();
}
  function selcourse() {
  var xhttp = new XMLHttpRequest();
