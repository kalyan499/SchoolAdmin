      ...
      <div class="os-tabs-w">
         <div class="os-tabs-controls">
           <ul class="nav nav-tabs upper">
            ...
            <li class="nav-item">
              <a class="nav-link active" href="locations_view.php">Locations</a>
            </li> 
			<li class="nav-item">
...
$res=$db->query($sql);
 ...
 ?>
 <form method="post" action="locations_insert.php" id="formID"  class="form-horizontal">
...
<td class="hidden-sm hidden-xs btn-group"><a href="locations_view.php?lid=<?php echo $row["location_id"]; ?>" class="btn btn-sm btn-info"><i class="ace-icon fa fa-pencil bigger-120"></i></a><a href="locations_delete.php?location_id=<?php echo $row["location_id"]; ?>"  class="btn btn-sm btn-danger" onClick="return confirm('Are you sure you want to delete this?')"><i class="ace-icon fa fa-trash-o bigger-120"></i></a></td>
</tr>
<?php
}
?>
