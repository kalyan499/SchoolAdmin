      ...
      <div class="os-tabs-w">
         <div class="os-tabs-controls">
           <ul class="nav nav-tabs upper">
            ...
            <li class="nav-item">
              <a class="nav-link active" href="student_fees_report.php">Student Fees Report</a>
            </li> 
			 <li class="nav-item">
              <a class="nav-link" href="hostel_report.php">Hostel Report</a>
            </li> 
			 <li class="nav-item">
              <a class="nav-link" href="transport_report.php">Transport Report</a>
            </li> 
										  ...
										  ?>
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="form-group btns">
                                                            ...
                                                            <br/>
                                                            <button class="btn btn-primary" onClick="getstudentfreport()">Generate</button>
                                                         
                                                        </div>
                                                    </div>
                                        
										<div id="sfreport" class="col-md-12">
...
html+="<head></head><body><h2>Sofica College of Nursing Fees Report</h2>";
  ...
  xhttp.onreadystatechange = function() {
    if (this.readyState == 4 && this.status == 200) {
      document.getElementById("sfreport").innerHTML =this.responseText;
    }
  };
  xhttp.open("GET", "getsfreport.php?course_id="+course_id+"&year="+year+"&academic_year="+academic_year, true);
  xhttp.send();
}
function getstudentfreportexcel() {
 
  var course_id=document.getElementById("course_id").value;
   var year=document.getElementById("year").value;
 
	  var academic_year=document.getElementById("academic_year").value;
	  document.location="getsfreportexcel.php?course_id="+course_id+"&year="+year+"&academic_year="+academic_year;
}
  function selcourse() {
  var xhttp = new XMLHttpRequest();
  var course_id=document.getElementById("course_id").value;
