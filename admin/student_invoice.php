                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <div class="clearfix">
                                                    <div class="float-left">
                                                         <p>Receipt No <strong><?php echo $row["invoice_number"]; ?></strong></p>
                                                    </div>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12 text-right">
                                                ...
                                                <!-- <a href="javascript:window.print()" class="btn btn-raised btn-success"><i class="fa fa-print"></i></a> -->
												 <a href="student_payments_view.php" class="btn btn-default">Cancel</a>
                                                <button class="btn btn-primary" onclick="myFunction()">Print</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                  <!-- This is for Print Invoice -->
                                <div class="card print_invoice_copy" style="display:none">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="header">
                                                <p>Office Copy</p>
                                                <div class="row">
                                                    <div class="col-md-12 text-center">
                                                        ...
                                                        <h5 class="no-margin-bottom">Abshot Layout, Vasanth Nagar, 
                                                            <br> Bengaluru, Karnataka 560051</h5>
                                       ...
                                       <tr>
										...
										?>
											...
											?>
                                                                ...
                                                                <tfoot>
                                                                    <td colspan="2" class="text-right"><strong>Total</strong></td>
                                                                    <td class="text-right"><i class="fa fa-rupee"></i> <strong> <?php echo $tot; ?></strong></td>
                                                                </tfoot>
                                                            </table>
                                                        </div>
                                                    </div>
