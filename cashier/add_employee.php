...
<form role="form">
    <div class="row setup-content" id="step-1">
                                             ...
                                             <div class="col-md-6">
                                    <h4 class="ptb-20">Eployee Information - (Academic Year) 2018</h4>
                                 </div>
                                 <div class="col-md-6">
                                    <div class="form-group">
                                       <label class="control-label">Code</label>
                    <input  maxlength="100" type="text" required="required" class="form-control" placeholder="Code" id="employee_code" name="employee_code" />
                                    </div>
                                 </div>
                                 ...
                                 <div class="col-md-3">
                                    <div class="form-group">
                                       ...
                                       <div class="input-group">
                                          <input class="form-control date-picker" id="date_of_birth" name="date_of_birth" type="date" data-date-format="dd-mm-yyyy" min="1975-01-01" max="1999-01-01">
                                 ...
                                 <div class="col-md-3">
                                    <div class="form-group">
                                       <label class="control-label" for="stuAddress">Emploeyee Address</label>
                                       <input type="text" id="address" name="address" required="required" class="form-control" placeholder="Emploeyee Address">
                                    </div>
                                 </div>
                                 <div class="col-md-3">
                                   <div class="form-group">
                    <label class="control-label">City</label>
                    <input maxlength="100" type="text" required="required" class="form-control" placeholder="City" name="city" id="city" />
                </div>
                                 </div>
                                 <div class="col-md-3">
                                    <div class="form-group">
                    ...
                    <input type="text" class="form-control" placeholder="Phone" id="phone" name="phone" />
                                 ...
                                 <div class="col-md-3">
                                     <div class="form-group">
                                       <label class="control-label" for="stuMobileno">Emploeyee Mobile No</label>
                                       <input type="text" id="mobile" name="mobile" required="required" class="form-control" placeholder="Emploeyee Mobile NO">
                </div>
                                 </div>
                                 <div class="col-md-3">
                                    <div class="form-group">
                                       <label class="control-label" for="stuEmail">Emploeyee eMail id</label>
                                       <input type="text" id="email" name="email" required="required" class="form-control" placeholder="Emploeyee eMail id">
                                    </div>
                                 </div>
                                 <div class="col-md-3">
                                    <div class="form-group">
                    ...
                    <input type="text" class="form-control" placeholder="PAN" id="pan_number" name="pan_number" />
                                 ...
                                 <div class="col-md-3">
                                    <div class="form-group">
                                       ...
                                       <input type="text" id="aadhar_number" name="aadhar_number" required="required" class="form-control" placeholder="Employee Adhaar No">
                                    </div>
                                 </div>
                                 <div class="col-md-3">
                                    <div class="form-group">
                                       <label class="control-label" for="stuEmrcno">Emergency Contact Number  </label>
                                       <input type="text" id="emergency_number" name="emergency_number" required="required" class="form-control" placeholder="Emergency Contact Number ">
                                    </div>
                                 </div>
                                 ...
                                 <div class="col-md-3">
                                    <div class="form-group">
                                       <label class="control-label" for="student_photo">Upload Employee Photo</label>
                                       <div class="card">
