                           ...
                           <form method="post" action="cash_handover_details_update.php" id="formID"  class="form-horizontal">
							...
							<div class="col-md-6">
								<div class="form-group row">
                                 ...
                                 <div class="col-sm-7">
                                    <input name="from_date" type="date" class="form-control" id="from_date" placeholder="From Date:" required value="<?php echo $row['from_date']; ?>">
                                 </div>
                              </div>
							  <div class="form-group row">
                                 <label class="col-sm-4 form-control-label no-padding-right" for="to_date">To Date:</label>
                                 <div class="col-sm-7">
                                    <input type="date" id="to_date" name="to_date" class="form-control" placeholder="To Date:" required value="<?php echo $row['to_date']; ?>">
                                 </div>
                              </div>
							  <div class="form-group row">
                                 <label class="col-sm-4 form-control-label no-padding-right" for="amount">Amount:</label>
                                 <div class="col-sm-7">
                                    <input name="amount" type="text" class="form-control" id="amount" placeholder="Amount" required value="<?php echo $row['amount']; ?>">
                                 </div>
                              </div>
							  <div class="form-group row">
                                 <label class="col-sm-4 form-control-label no-padding-right" for="hand_over_date">Hand Over Date:</label>
                                 <div class="col-sm-7">
                                    <input type="date" id="hand_over_date" name="hand_over_date" class="form-control" placeholder="Hand Over Date" required value="<?php echo $row['hand_over_date']; ?>">
                                 </div>
                              </div>
							  <div class="form-group row">
