        ...
        <div class="content-inner">
          ...
          <header class="page-header">
            ...
            <div class="container-fluid">
              ...
              <h2 class="no-margin-bottom">Add New Castes</h2>
...
<label class="col-sm-3 form-control-label no-padding-right" for="caste_name">Caste Name:</label>
    ...
    <input type="text" id="caste_name" name="caste_name" class="col-xs-10 col-sm-5 form-control" placeholder="Caste Name:" required>
