        ...
        <div class="content-inner">
          ...
          <header class="page-header">
            ...
            <div class="container-fluid">
              ...
              <h2 class="no-margin-bottom">Permissions Edit</h2>
...
?>
<?php include("val.php"); ?>
<form method="post" action="permissions_update.php" id="formID"  class="form-horizontal">
...
<label class="col-sm-3 form-control-label no-padding-right" for="controller">Controller:</label>
    ...
    <input type="text" id="controller" name="controller" class="col-xs-10 col-sm-5 form-control" placeholder="Controller:" value="<?php echo $row['controller']; ?>">
...
<label class="col-sm-3 form-control-label no-padding-right" for="action">Action:</label>
    ...
    <input type="text" id="action" name="action" class="col-xs-10 col-sm-5 form-control" placeholder="Action:" value="<?php echo $row['action']; ?>">
...
<label class="col-sm-3 form-control-label no-padding-right" for="permitted">Permitted:</label>
    ...
    <input type="text" id="permitted" name="permitted" class="col-xs-10 col-sm-5 form-control" placeholder="Permitted:" value="<?php echo $row['permitted']; ?>">
