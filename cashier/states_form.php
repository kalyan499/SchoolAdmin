        ...
        <div class="content-inner">
          ...
          <header class="page-header">
            ...
            <div class="container-fluid">
              ...
              <h2 class="no-margin-bottom">Add New States</h2>
...
{
?>
<option value="<?php echo $rowr["country_id"]; ?>"><?php echo $rowr["country_name"]; ?></option>
<?php
}
?>
</select>
...
<label class="col-sm-3 form-control-label no-padding-right" for="state_name">State Name:</label>
    ...
    <input type="text" id="state_name" name="state_name" class="col-xs-10 col-sm-5 form-control" placeholder="State Name:" required>
