        ...
        <div class="content-inner">
          ...
          <header class="page-header">
            ...
            <div class="container-fluid">
              ...
              <h2 class="no-margin-bottom">Student Subjects Edit</h2>
...
$sql="select * from student_subjects where student_subject_id='$student_subject_id'";
$res=$db->query($sql);
...
?>
<?php include("val.php"); ?>
<form method="post" action="student_subjects_update.php" id="formID"  class="form-horizontal">
<input type="hidden" id="student_subject_id" name="student_subject_id" value="<?php echo $student_subject_id; ?>">
