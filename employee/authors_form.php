        ...
        <div class="content-inner">
          ...
          <header class="page-header">
            ...
            <div class="container-fluid">
              ...
              <h2 class="no-margin-bottom">Add New Authors</h2>
...
<label class="col-sm-3 form-control-label no-padding-right" for="author_name">Author Name:</label>
    ...
    <input type="text" id="author_name" name="author_name" class="col-xs-10 col-sm-5 form-control" placeholder="Author Name:" required>
