...
?>
<tr>
<td><?php echo $row["cash_handover_id"]; ?></td>
...
<td class="hidden-sm hidden-xs btn-group"><a href="cash_handover_details_edit.php?=<?php echo $row[""]; ?>" class="btn btn-sm btn-info"><i class="ace-icon fa fa-pencil bigger-120"></i></a><a href="cash_handover_details_delete.php?=<?php echo $row[""]; ?>"  class="btn btn-sm btn-danger" onClick="return confirm('Are you sure you want to delete this?')"><i class="ace-icon fa fa-trash-o bigger-120"></i></a></td>
</tr>
<?php
}
?>
