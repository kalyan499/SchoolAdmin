...
<td class="hidden-sm hidden-xs btn-group"><a href="employee_leave_requests_edit.php?employee_leave_request_id=<?php echo $row["employee_leave_request_id"]; ?>" class="btn btn-sm btn-info"><i class="ace-icon fa fa-pencil bigger-120"></i></a><a href="employee_leave_requests_delete.php?employee_leave_request_id=<?php echo $row["employee_leave_request_id"]; ?>"  class="btn btn-sm btn-danger" onClick="return confirm('Are you sure you want to delete this?')"><i class="ace-icon fa fa-trash-o bigger-120"></i></a></td>
</tr>
<?php
}
?>
