        ...
        <div class="content-inner">
          ...
          <header class="page-header">
            ...
            <div class="container-fluid">
              ...
              <h2 class="no-margin-bottom">Students Edit</h2>
...
?>
<?php include("val.php"); ?>
<form method="post" action="students_update.php" id="formID"  class="form-horizontal">
...
<label class="col-sm-3 form-control-label no-padding-right" for="sudent_photo">Sudent Photo:</label>
    ...
    <input type="file" id="sudent_photo" name="sudent_photo" class="col-xs-10 col-sm-5 form-control" placeholder="Sudent Photo:" value="<?php echo $row['sudent_photo']; ?>">
...
<label class="col-sm-3 form-control-label no-padding-right" for="admission_number">Admission Number:</label>
    ...
    <input type="text" id="admission_number" name="admission_number" class="col-xs-10 col-sm-5 form-control" placeholder="Admission Number:" value="<?php echo $row['admission_number']; ?>">
...
<label class="col-sm-3 form-control-label no-padding-right" for="roll_number">Roll Number:</label>
    ...
    <input type="text" id="roll_number" name="roll_number" class="col-xs-10 col-sm-5 form-control" placeholder="Roll Number:" value="<?php echo $row['roll_number']; ?>">
...
<label class="col-sm-3 form-control-label no-padding-right" for="religion_id">Religion:</label>
	   ...
	   <select id="religion_id" name="religion_id" class="col-xs-10 col-sm-5 form-control" >
...
<label class="col-sm-3 form-control-label no-padding-right" for="caste_id">Caste:</label>
	   ...
	   <select id="caste_id" name="caste_id" class="col-xs-10 col-sm-5 form-control" >
...
{
?>
<option value="<?php echo $rowr["caste_id"]; ?>" <?php if($rowr['caste_id']==$row['caste_id']){ echo "selected";} ?>><?php echo $rowr["caste_name"]; ?></option>
<?php
}
?>
</select>
...
<div class="i-checks in-block">
          ...
          <input type="radio" class="radio-template" id="rte" name="rte" value="Yes"  <?php if($row['rte']=="Yes"){ echo "checked";} ?>>
...
<div class="i-checks in-block">
          ...
          <input type="radio" class="radio-template" id="rte" name="rte" value="No"  <?php if($row['rte']=="No"){ echo "checked";} ?>>
...
<label class="col-sm-3 form-control-label no-padding-right" for="emergency_contact_number">Emergency Contact Number:</label>
    ...
    <input type="text" id="emergency_contact_number" name="emergency_contact_number" class="col-xs-10 col-sm-5 form-control" placeholder="Emergency Contact Number:" value="<?php echo $row['emergency_contact_number']; ?>">
...
<div class="i-checks in-block">
          ...
          <input type="radio" class="radio-template" id="hostel_opted" name="hostel_opted" value="Yes"  <?php if($row['hostel_opted']=="Yes"){ echo "checked";} ?>>
...
<div class="i-checks in-block">
          ...
          <input type="radio" class="radio-template" id="hostel_opted" name="hostel_opted" value="No"  <?php if($row['hostel_opted']=="No"){ echo "checked";} ?>>
...
<div class="i-checks in-block">
          ...
          <input type="radio" class="radio-template" id="transport_opted" name="transport_opted" value="Yes"  <?php if($row['transport_opted']=="Yes"){ echo "checked";} ?>>
...
<div class="i-checks in-block">
          ...
          <input type="radio" class="radio-template" id="transport_opted" name="transport_opted" value="No"  <?php if($row['transport_opted']=="No"){ echo "checked";} ?>>
...
<label class="col-sm-3 form-control-label no-padding-right" for="agent_id">Agent:</label>
	   ...
	   <select id="agent_id" name="agent_id" class="col-xs-10 col-sm-5 form-control" >
...
{
?>
<option value="<?php echo $rowr["agent_id"]; ?>" <?php if($rowr['agent_id']==$row['agent_id']){ echo "selected";} ?>><?php echo $rowr["agent_name"]; ?></option>
<?php
}
?>
</select>
...
<label class="col-sm-3 form-control-label no-padding-right" for="bus_route_id">Bus Route:</label>
	   ...
	   <select id="bus_route_id" name="bus_route_id" class="col-xs-10 col-sm-5 form-control" >
...
{
?>
<option value="<?php echo $rowr["bus_route_id"]; ?>" <?php if($rowr['bus_route_id']==$row['bus_route_id']){ echo "selected";} ?>><?php echo $rowr["route_number"]; ?></option>
<?php
}
?>
</select>
...
<label class="col-sm-3 form-control-label no-padding-right" for="parent_mobile">Parent Mobile:</label>
    ...
    <input type="text" id="parent_mobile" name="parent_mobile" class="col-xs-10 col-sm-5 form-control" placeholder="Parent Mobile:" value="<?php echo $row['parent_mobile']; ?>">
...
<label class="col-sm-3 form-control-label no-padding-right" for="parent_email">Parent Email:</label>
    ...
    <input type="email" id="parent_email" name="parent_email" class="col-xs-10 col-sm-5 form-control" placeholder="Parent Email:" value="<?php echo $row['parent_email']; ?>">
...
<label class="col-sm-3 form-control-label no-padding-right" for="current_class_sem">Current Class/Sem:</label>
    ...
    <input type="text" id="current_class_sem" name="current_class_sem" class="col-xs-10 col-sm-5 form-control" placeholder="Current Class/Sem:" value="<?php echo $row['current_class_sem']; ?>">
