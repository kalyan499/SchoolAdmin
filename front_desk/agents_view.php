...
<?php include("sidebar.php"); ?>
    ...
    <div class="panel panel-default">
      <div class="panel-heading">
        <h4 data-toggle="collapse" data-parent="#newAgent" href="#newAgentCollapse" class="panel-title expand">
...
<td class="hidden-sm hidden-xs btn-group"><a href="agents_edit.php?agent_id=<?php echo $row["agent_id"]; ?>" class="btn btn-sm btn-info"><i class="ace-icon fa fa-pencil bigger-120"></i></a><a href="agents_delete.php?agent_id=<?php echo $row["agent_id"]; ?>"  class="btn btn-sm btn-danger" onClick="return confirm('Are you sure you want to delete this?')"><i class="ace-icon fa fa-trash-o bigger-120"></i></a></td>
</tr>
<?php
}
?>
