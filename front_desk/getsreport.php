...
$sel=" and (registration_date>='$sdate' and registration_date<='$edate')";
if($sdate==$edate)
$sel=" and registration_date like '$sdate%'";
$sql="select * from students s,courses c where s.course_id=c.course_id and s.course_id='$course_id' and current_year='$year' and academic_year='$academic_year'".$sel;
?>
