            ...
            <div class="navbar-holder d-flex align-items-center justify-content-between">
              ...
              <div class="navbar-header">
                <!-- Navbar Brand --><a href="home.php" class="navbar-brand">
                  <div class="brand-text brand-big"><img src="../img/school_logo.png" width="30"/> <span> Mount Carmel </span><strong> Central School</strong></div>
                                <div class="brand-text brand-small"><img src="../img/school_logo.png" width="30"/></div></a>
              ...
              <ul class="nav-menu list-unstyled d-flex flex-md-row align-items-md-center">
               ...
               <!-- <li class="nav-item dropdown"> 
				...
				<li class="nav-item">
                <a data-target="#" href="#"  class="nav-link " tabindex="0">
                  
                    <span class="hidden-xs">
                        <span data-translate="LISA" class="ng-scope">Admin</span>
                    </span>
                </a> 
            </li>
