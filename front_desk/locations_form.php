        ...
        <div class="content-inner">
          ...
          <header class="page-header">
            ...
            <div class="container-fluid">
              ...
              <h2 class="no-margin-bottom">Add New Locations</h2>
...
<label class="col-sm-3 form-control-label no-padding-right" for="location">Location:</label>
    ...
    <input type="text" id="location" name="location" class="col-xs-10 col-sm-5 form-control" placeholder="Location:" required>
