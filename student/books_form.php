        ...
        <div class="content-inner">
          ...
          <header class="page-header">
            ...
            <div class="container-fluid">
              ...
              <h2 class="no-margin-bottom">Add New Books</h2>
...
<label class="col-sm-3 form-control-label no-padding-right" for="author_id">Author Id:</label>
    ...
    <input type="text" id="author_id" name="author_id" class="col-xs-10 col-sm-5 form-control" placeholder="Author Id:" required>
...
<label class="col-sm-3 form-control-label no-padding-right" for="availability">Availability:</label>
    ...
    <input type="text" id="availability" name="availability" class="col-xs-10 col-sm-5 form-control" placeholder="Availability:" required>

	</div>
</div>
<div class="form-group row">
<label class="col-sm-3 form-control-label no-padding-right" for="modified">Modified:</label>

	   <div class="col-sm-9">

    <input type="text" id="modified" name="modified" class="col-xs-10 col-sm-5 form-control" placeholder="Modified:" required>
