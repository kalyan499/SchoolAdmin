...
<label class="col-sm-3 form-control-label no-padding-right" for="cash_handover_id">Cash Handover Id:</label>
    ...
    <input type="text" id="cash_handover_id" name="cash_handover_id" class="col-xs-10 col-sm-5 form-control" placeholder="Cash Handover Id:" value="<?php echo $row['cash_handover_id']; ?>">
