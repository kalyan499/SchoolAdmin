        ...
        <div class="content-inner">
          ...
          <header class="page-header">
            ...
            <div class="container-fluid">
              ...
              <h2 class="no-margin-bottom">Add New Categories</h2>
...
<label class="col-sm-3 form-control-label no-padding-right" for="category_name">Category Name:</label>
    ...
    <input type="text" id="category_name" name="category_name" class="col-xs-10 col-sm-5 form-control" placeholder="Category Name:" required>
