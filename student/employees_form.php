        ...
        <div class="content-inner">
          ...
          <header class="page-header">
            ...
            <div class="container-fluid">
              ...
              <h2 class="no-margin-bottom">Add New Employees</h2>
...
$db->connect(); ?>
<form method="post" action="employees_insert.php" id="formID" class="form-horizontal">
...
<label class="col-sm-3 form-control-label no-padding-right" for="employee_photo">Employee Photo:</label>
    ...
    <input type="file" id="employee_photo" name="employee_photo" class="col-xs-10 col-sm-5 form-control" placeholder="Employee Photo:" required>
...
<label class="col-sm-3 form-control-label no-padding-right" for="employee_type_id">Employee Type:</label>
	   ...
	   <select id="employee_type_id" name="employee_type_id" class="col-xs-10 col-sm-5 form-control" required>
...
{
?>
<option value="<?php echo $rowr["employee_type_id"]; ?>"><?php echo $rowr["employee_type"]; ?></option>
<?php
}
?>
</select>
...
<label class="col-sm-3 form-control-label no-padding-right" for="employee_code">Employee Code:</label>
    ...
    <input type="text" id="employee_code" name="employee_code" class="col-xs-10 col-sm-5 form-control" placeholder="Employee Code:" required>
...
<label class="col-sm-3 form-control-label no-padding-right" for="pan_number">Pan Number:</label>
    ...
    <input type="text" id="pan_number" name="pan_number" class="col-xs-10 col-sm-5 form-control" placeholder="Pan Number:" required>
...
<label class="col-sm-3 form-control-label no-padding-right" for="emergency_number">Emergency Number:</label>
    ...
    <input type="text" id="emergency_number" name="emergency_number" class="col-xs-10 col-sm-5 form-control" placeholder="Emergency Number:" required>
...
<label class="col-sm-3 form-control-label no-padding-right" for="joining_date">Joining Date:</label>
    ...
    <input type="date" id="joining_date" name="joining_date" class="col-xs-10 col-sm-5 form-control" placeholder="Joining Date:" required>
...
<label class="col-sm-3 form-control-label no-padding-right" for="job_type_id">Job Type:</label>
	   ...
	   <select id="job_type_id" name="job_type_id" class="col-xs-10 col-sm-5 form-control" required>
...
<label class="col-sm-3 form-control-label no-padding-right" for="bank_account_number">Bank Account Number:</label>
    ...
    <input type="text" id="bank_account_number" name="bank_account_number" class="col-xs-10 col-sm-5 form-control" placeholder="Bank Account Number:" required>
...
<label class="col-sm-3 form-control-label no-padding-right" for="confirmation_period">Confirmation Period:</label>
    ...
    <input type="text" id="confirmation_period" name="confirmation_period" class="col-xs-10 col-sm-5 form-control" placeholder="Confirmation Period:" required>
...
<label class="col-sm-3 form-control-label no-padding-right" for="department_id">Department:</label>
	   ...
	   <select id="department_id" name="department_id" class="col-xs-10 col-sm-5 form-control" required>
...
<label class="col-sm-3 form-control-label no-padding-right" for="location_id">Location:</label>
	   ...
	   <select id="location_id" name="location_id" class="col-xs-10 col-sm-5 form-control" required>
...
<label class="col-sm-3 form-control-label no-padding-right" for="designation_id">Designation:</label>
	   ...
	   <select id="designation_id" name="designation_id" class="col-xs-10 col-sm-5 form-control" required>
...
<label class="col-sm-3 form-control-label no-padding-right" for="is_pf_enabled">PF Enabled:</label>
    ...
    <input type="text" id="is_pf_enabled" name="is_pf_enabled" class="col-xs-10 col-sm-5 form-control" placeholder="PF Enabled:" required>
...
<label class="col-sm-3 form-control-label no-padding-right" for="pf_uan">PF UAN:</label>
    ...
    <input type="text" id="pf_uan" name="pf_uan" class="col-xs-10 col-sm-5 form-control" placeholder="PF UAN:" required>
...
<label class="col-sm-3 form-control-label no-padding-right" for="pf_number">PF Number:</label>
    ...
    <input type="text" id="pf_number" name="pf_number" class="col-xs-10 col-sm-5 form-control" placeholder="PF Number:" required>
...
<label class="col-sm-3 form-control-label no-padding-right" for="pf_enrollment_date">PF Enrollment Date:</label>
    ...
    <input type="date" id="pf_enrollment_date" name="pf_enrollment_date" class="col-xs-10 col-sm-5 form-control" placeholder="PF Enrollment Date:" required>
...
<label class="col-sm-3 form-control-label no-padding-right" for="epf_number">EPF Number:</label>
    ...
    <input type="text" id="epf_number" name="epf_number" class="col-xs-10 col-sm-5 form-control" placeholder="EPF Number:" required>
...
<label class="col-sm-3 form-control-label no-padding-right" for="relationship">Relationship:</label>
    ...
    <input type="text" id="relationship" name="relationship" class="col-xs-10 col-sm-5 form-control" placeholder="Relationship:" required>
...
<label class="col-sm-3 form-control-label no-padding-right" for="is_eps_enabled">EPS Enabled:</label>
    ...
    <input type="text" id="is_eps_enabled" name="is_eps_enabled" class="col-xs-10 col-sm-5 form-control" placeholder="EPS Enabled:" required>
...
<label class="col-sm-3 form-control-label no-padding-right" for="is_esi_enabled">ESI Enabled:</label>
    ...
    <input type="text" id="is_esi_enabled" name="is_esi_enabled" class="col-xs-10 col-sm-5 form-control" placeholder="ESI Enabled:" required>
...
<label class="col-sm-3 form-control-label no-padding-right" for="esi_number">ESI Number:</label>
    ...
    <input type="text" id="esi_number" name="esi_number" class="col-xs-10 col-sm-5 form-control" placeholder="ESI Number:" required>
