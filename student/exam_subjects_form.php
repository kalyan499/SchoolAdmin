        ...
        <div class="content-inner">
          ...
          <header class="page-header">
            ...
            <div class="container-fluid">
              ...
              <h2 class="no-margin-bottom">Add New Exam Subjects</h2>
...
$db->connect(); ?>
<form method="post" action="exam_subjects_insert.php" id="formID" class="form-horizontal">
<div class="form-group row">
<label class="col-sm-3 form-control-label no-padding-right" for="exam_id">Exam:</label>

	   <div class="col-sm-9">

	   <select id="exam_id" name="exam_id" class="col-xs-10 col-sm-5 form-control" required>
...
{
?>
<option value="<?php echo $rowr["exam_id"]; ?>"><?php echo $rowr["name"]; ?></option>
<?php
}
?>
</select>
...
<label class="col-sm-3 form-control-label no-padding-right" for="sem">Class/Sem:</label>
    ...
    <input type="text" id="sem" name="sem" class="col-xs-10 col-sm-5 form-control" placeholder="Class/Sem:" required>
