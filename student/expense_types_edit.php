        ...
        <div class="content-inner">
          ...
          <header class="page-header">
            ...
            <div class="container-fluid">
              ...
              <h2 class="no-margin-bottom">Expense Types Edit</h2>
...
?>
<?php include("val.php"); ?>
<form method="post" action="expense_types_update.php" id="formID"  class="form-horizontal">
...
<label class="col-sm-3 form-control-label no-padding-right" for="expense_type">Expense Type:</label>
    ...
    <input type="text" id="expense_type" name="expense_type" class="col-xs-10 col-sm-5 form-control" placeholder="Expense Type:" value="<?php echo $row['expense_type']; ?>">
