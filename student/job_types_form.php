        ...
        <div class="content-inner">
          ...
          <header class="page-header">
            ...
            <div class="container-fluid">
              ...
              <h2 class="no-margin-bottom">Add New Job Types</h2>
...
<label class="col-sm-3 form-control-label no-padding-right" for="job_type_name">Job Type Name:</label>
    ...
    <input type="text" id="job_type_name" name="job_type_name" class="col-xs-10 col-sm-5 form-control" placeholder="Job Type Name:" required>
