        ...
        <div class="content-inner">
          ...
          <header class="page-header">
            ...
            <div class="container-fluid">
              ...
              <h2 class="no-margin-bottom">Add New Religions</h2>
...
<label class="col-sm-3 form-control-label no-padding-right" for="religion_name">Religion Name:</label>
    ...
    <input type="text" id="religion_name" name="religion_name" class="col-xs-10 col-sm-5 form-control" placeholder="Religion Name:" required>
