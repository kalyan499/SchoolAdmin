...
<label class="col-sm-3 form-control-label no-padding-right" for="password">Password:</label>
    ...
    <input type="text" id="password" name="password" class="col-xs-10 col-sm-5 form-control" placeholder="Password:" value="<?php echo $row['password']; ?>">
...
<label class="col-sm-3 form-control-label no-padding-right" for="active">Active:</label>
    ...
    <input type="text" id="active" name="active" class="col-xs-10 col-sm-5 form-control" placeholder="Active:" value="<?php echo $row['active']; ?>">
