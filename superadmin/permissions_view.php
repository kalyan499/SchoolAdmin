...
$db->connect();
$sn=1;
$sql="select * from permissions t1,roles t2 where t1.role_id=t2.role_id";
$res=$db->query($sql);
...
<td class="hidden-sm hidden-xs btn-group"><a href="permissions_edit.php?permission_id=<?php echo $row["permission_id"]; ?>" class="btn btn-sm btn-info"><i class="ace-icon fa fa-pencil bigger-120"></i></a><a href="permissions_delete.php?permission_id=<?php echo $row["permission_id"]; ?>"  class="btn btn-sm btn-danger" onClick="return confirm('Are you sure you want to delete this?')"><i class="ace-icon fa fa-trash-o bigger-120"></i></a></td>
</tr>
<?php
}
?>
