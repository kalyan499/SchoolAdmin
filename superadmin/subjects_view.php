        ...
        <div class="content-inner">
          ...
          <header class="page-header">
            ...
            <div class="container-fluid">
              ...
              <h2 class="no-margin-bottom">Subjects List</h2>
              ...
              <div class="row">
                ...
                <div class="col-lg-12">
                  ...
                  <div class="card">
                    ...
                    <div class="card-body">
<form method="post" action="subjects_insert.php" id="formID" class="form-horizontal">
<div class="form-group row">
<label class="col-sm-3 form-control-label no-padding-right" for="subject_name">Subject Name:</label>

	   <div class="col-sm-9">

    <input type="text" id="subject_name" name="subject_name" class="col-xs-10 col-sm-5 form-control" placeholder="Subject Name:" required>
...
<td class="hidden-sm hidden-xs btn-group"><a href="subjects_edit.php?subject_id=<?php echo $row["subject_id"]; ?>" class="btn btn-sm btn-info"><i class="ace-icon fa fa-pencil bigger-120"></i></a><a href="subjects_delete.php?subject_id=<?php echo $row["subject_id"]; ?>"  class="btn btn-sm btn-danger" onClick="return confirm('Are you sure you want to delete this?')"><i class="ace-icon fa fa-trash-o bigger-120"></i></a></td>
</tr>
<?php
}
?>
